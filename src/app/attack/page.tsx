  ...
  return (
    <div className="space-y-8">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Enter an agreement address to request attack mode (transitions from NEW_DEPLOYMENT to ATTACK_REQUESTED).
          </p>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Enter an agreement address to auto-poll its current state every 5 seconds.
          </p>
